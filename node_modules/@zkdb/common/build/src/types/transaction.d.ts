...
export type TTransactionRecordNullable = TNullable<TTransactionRecord, 'error' | 'txHash'>;
/**
 * Transaction request
...
export type TTransactionDraftResponse = TPickAlter<TTransactionRecordNullable, {
 ...
 */
export type TTransactionQueue = Pick<TTransaction, 'databaseName' | 'transactionType'> & {
