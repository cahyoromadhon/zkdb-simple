...
export type TCollectionMetadata = TCollection & Partial<TCollectionMetadataMongo> & TMetadataBasic;
 ...
 *
 */
export type TMetadataDetail<T, M> = T & {
    metadata: M;
};
export type TMetadataDetailDocument<T> = TMetadataDetail<T, TDocumentMetadata>;
export type TDocumentMetadataRequest = TDatabaseRequest & Pick<TCollection, 'collectionName'> & Pick<TDocument, 'docId'>;
export type TDocumentMetadataResponse = TDocumentMetadata | null;
export type TCollectionMetadataRequest = Omit<TDocumentMetadataRequest, 'docId'>;
