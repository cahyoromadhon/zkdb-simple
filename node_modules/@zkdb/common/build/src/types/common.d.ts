...
export type TPickAlter<T, P extends Partial<Record<keyof T, string>>> = {
    [K in keyof P as K extends keyof T ? P[K] extends string ? P[K] : never : never]: K extends keyof T ? T[K] : never;
};
export type TNullable<T, K extends keyof T> = {
    [P in keyof T]: P extends K ? T[P] | null : T[P];
};
export type TPickOptional<T, K extends keyof T> = Omit<T, K> & Partial<Pick<T, K>>;
