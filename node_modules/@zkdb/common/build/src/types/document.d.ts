...
export type TDocumentRecordNullable = TNullable<TDocumentRecord, 'previousObjectId'>;
...
export type TDocumentHistoryFindResponse = TPaginationReturn<TDocumentResponse[]>;
export type TDocumentPrefixed = {
    [K in keyof TDbRecord<TDocument> as `$zkdb::${string & K}`]: TDbRecord<TDocument>[K];
};
