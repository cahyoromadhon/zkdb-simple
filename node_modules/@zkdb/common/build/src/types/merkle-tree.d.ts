...
export type TMerkleNode = Pick<TMerkleField<TMerkle>, 'hash' | 'level' | 'index'>;
...
export type TMerkleNodeDetailJson = TMerkleJson<TMerkleNode> & TMerkleEmptyNode & TMerkleWitness;
...
export type TMerkleTreeNodeListByLevelResponse = TPaginationReturn<TMerkleNodeJson[]>;
export type TMerkleTreeInfoRequest = TDatabaseRequest;
export type TMerkleTreeInfoResponse = TMerkleTreeInfo;
export type TMerkleTreeNodeChildrenRequest = TDatabaseRequest & Pick<TMerkle, 'index' | 'level'>;
