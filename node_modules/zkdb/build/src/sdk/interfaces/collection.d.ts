import { TCollectionIndex, TCollectionMetadata, TDocumentCreateResponse, TDocumentPrefixed, TPagination, TPaginationReturn, TSchemaExtendable } from '@zkdb/common';
...
export interface ICollection<T extends TSchemaExtendable<any>> {
    ...
    findMany(filter?: Partial<TDocumentPrefixed & T['innerStructure']>, pagination?: TPagination): Promise<TPaginationReturn<IDocument<T>[]>>;
